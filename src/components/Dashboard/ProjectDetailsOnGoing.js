...
const fetch = async () => {
let index = 46637282; //current app id need to be entered
setappid(index);
                        ...
                        <div className="card-sale d-flex flex-column">
                            <div className="card-sale-heading d-flex flex-wrap align-items-start justify-content-between">
                                <div className="card-sale-title d-flex align-items-center">
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button className="btn btn-cta ms-auto" style={{backgroundColor: "#e7e7e7"}} onClick={()=>Optin()}>Opt-In</button> <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(opt-in only one time)</p>
                                </div>
                            ...
                            {lock == true ? (<><button className="btn btn-cta ms-auto" style={{backgroundColor: "#e7e7e7"}} onClick={()=>Donate()}>Donate</button></>):(<><button className="btn btn-cta ms-auto" >Claim</button></>)}
